...
parser.add_argument('--csv_path', type=str, default='..//train1_openface/train1_512_audio.csv')
parser.add_argument('--deepface_path', type=str, default='..//train1_deep3Dface/train1.npz')
parser.add_argument('--save_path', type=str, default='..//train1_posenew.npz')
